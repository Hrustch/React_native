...
export const loginFirebaseThunk = createAsyncThunk("auth/loginFirebaseThunk", loginDB);

export const logOutThunk = createAsyncThunk("auth/logOut", LogOut);

export const registrationThunk = createAsyncThunk("auth/registration", Registration);
...
export const updateUserProfileThunk = createAsyncThunk("auth/updateUser", updateUserProfile);
